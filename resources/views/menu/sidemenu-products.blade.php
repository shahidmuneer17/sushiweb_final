      ...
      <div class="accordion-item">
        ...
        <div id="collapse{{ $category->cat_id }}" class="accordion-collapse collapsed collapse" aria-labelledby="heading{{ $category->cat_id }}" data-bs-parent="#accordionExample">
          <div class="accordion-body">
            ...
            <div class="accd">
              <a href="/menu/#cats_{{ $subcategory->subcat_id }}">{{ $subcategory->subcat_name }}</a></div>
            @endforeach
          </div>
        </div>
        @endforeach
  ...
  @foreach($categories as $category)
    @foreach($category->subcategories as $subcategory)
      <div class="accd-mob" style="display: flex; gap: 10px;">
        <a href="/menu/#cats_{{ $subcategory->subcat_id }}">{{ $subcategory->subcat_name }}</a>
      </div>
    @endforeach
  @endforeach
</div>
